...
if _HAS_PROMPT_SERVER:
    ...
    @PromptServer.instance.routes.post("/EagleLoraList/clearCache")
    async def clear_lora_cache(request):
        list_data_cache.clear()
        return web.json_response({"success": True, "message": "缓存已清除"})

    @PromptServer.instance.routes.post("/EagleLoraList/deleteLora")
    ...
    @PromptServer.instance.routes.post("/eagle/read_file")
    ...
    @PromptServer.instance.routes.get("/EagleLoraList/loadLoraList")
    ...
    @PromptServer.instance.routes.post("/EagleLoraList/rename_lora")
    ...
    @PromptServer.instance.routes.get("/EagleLoraList/getFileHash")
    ...
    @PromptServer.instance.routes.get("/EagleLoraList/getLoraMetadata")
