...
if _HAS_PROMPT_SERVER:
    ...
    @PromptServer.instance.routes.get("/tts/{path:.*}")
    ...
    @PromptServer.instance.routes.get("/EagleAudioList/search_audio")
    ...
    @PromptServer.instance.routes.post("/EagleAudioList/rename_audio")
