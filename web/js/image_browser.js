...
var CSS = [
  ...
  ".ib-card{position:relative;border-radius:8px;overflow:hidden;cursor:pointer;border:2px solid transparent;background:#1a1a24;transition:border-color .15s;content-visibility:auto;contain-intrinsic-size:140px 180px}",
